...
% auxiliar
if eMOGA.Generations==1 % Number of generations should be >= 2
    eMOGA.Generations=2;
end 
eMOGA.dd_fin=((eMOGA.dd_ini/eMOGA.dd_fin)^2-1)/(eMOGA.Generations-1); 
eMOGA.Sigma_Pm_fin=((eMOGA.Sigma_Pm_ini/eMOGA.Sigma_Pm_fin)^2-1)/(eMOGA.Generations-1);
% End initialization ----------------------------------------
...
sigma=eMOGA.Sigma_Pm_ini/sqrt(1+eMOGA.gen_counter*eMOGA.Sigma_Pm_fin);
...
dd=eMOGA.dd_ini/sqrt(1+eMOGA.gen_counter*eMOGA.dd_fin);
